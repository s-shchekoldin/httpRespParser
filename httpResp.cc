...
{
    static uint8_t text[] = { 0x74, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x65, 0x72, 0x2d, 0x65, 0x6e, 0x63, 0x6f, 0x64, 0x69, 0x6e, 0x67, 0x3a }; // Transfer-Encoding:
    for(; state.data < state.end; state.data++)
    {
        uint8_t sym = (uint8_t)state.data[0];
        if (sym >= 'A' && sym <= 'Z')
...
{
    static uint8_t text[] = { 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x2d, 0x65, 0x6e, 0x63, 0x6f, 0x64, 0x69, 0x6e, 0x67, 0x3a }; // Content-Encoding:
    for(; state.data < state.end; state.data++)
    {
        uint8_t sym = (uint8_t)state.data[0];
        if (sym >= 'A' && sym <= 'Z')
...
{
    static uint8_t text[] = { 0x63, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x3a }; // Connection:
    for(; state.data < state.end; state.data++)
    {
        uint8_t sym = (uint8_t)state.data[0];
        if (sym >= 'A' && sym <= 'Z')
...
const char * httpResp::state_t::name() const
{
    switch(node)
    {
        ...
        case TEXT_2_0: return "TEXT_2_0";
        case RANGE_2_1: return "RANGE_2_1";
        case TEXT_2_2: return "TEXT_2_2";
        case RANGE_2_3: return "RANGE_2_3";
        case RANGE_2_4: return "RANGE_2_4";
        case RANGE_2_5: return "RANGE_2_5";
        case RANGE_2_6: return "RANGE_2_6";
        case RANGE_2_7: return "RANGE_2_7";
        case TEXT_2_8: return "TEXT_2_8";
        case TEXT_2_9: return "TEXT_2_9";
        case GOTO_2_10: return "GOTO_2_10";
        case RESET_2_11: return "RESET_2_11";
        case LOOP_4_0: return "LOOP_4_0";
        case LABEL_4_0: return "LABEL_4_0";
        case LOOP_4_1: return "LOOP_4_1";
        case RANGE_5_0: return "RANGE_5_0";
        case RANGE_5_1: return "RANGE_5_1";
        case TEXT_5_2: return "TEXT_5_2";
        case TEXT_5_3: return "TEXT_5_3";
        case TEXT_6_0: return "TEXT_6_0";
        case RANGE_6_1: return "RANGE_6_1";
        case STRING_6_2: return "STRING_6_2";
        case TEXT_6_3: return "TEXT_6_3";
        case TEXT_6_4: return "TEXT_6_4";
        case ANY_7_0: return "ANY_7_0";
        case TEXT_7_0_0_0: return "TEXT_7_0_0_0";
        case BANG_7_0: return "BANG_7_0";
        case RANGE_7_2: return "RANGE_7_2";
        case FUNC_7_3: return "FUNC_7_3";
        case UINT_7_4: return "UINT_7_4";
        case RANGE_7_5: return "RANGE_7_5";
        case TEXT_7_6: return "TEXT_7_6";
        case TEXT_7_7: return "TEXT_7_7";
        case ANY_8_0: return "ANY_8_0";
        case TEXT_8_0_0_0: return "TEXT_8_0_0_0";
        case BANG_8_0: return "BANG_8_0";
        case RANGE_8_2: return "RANGE_8_2";
        case STRING_8_3: return "STRING_8_3";
        case FUNC_8_4: return "FUNC_8_4";
        case TEXT_8_5: return "TEXT_8_5";
        case TEXT_8_6: return "TEXT_8_6";
        case ANY_9_0: return "ANY_9_0";
        case TEXT_9_0_0_0: return "TEXT_9_0_0_0";
        case BANG_9_0: return "BANG_9_0";
        case RANGE_9_2: return "RANGE_9_2";
        case STRING_9_3: return "STRING_9_3";
        case FUNC_9_4: return "FUNC_9_4";
        ...
        case TEXT_10_4: return "TEXT_10_4";
        case TEXT_10_5: return "TEXT_10_5";
        case TEXT_11_0: return "TEXT_11_0";
        case TEXT_11_1: return "TEXT_11_1";
        case LOOP_11_2: return "LOOP_11_2";
        case FUNC_12_0: return "FUNC_12_0";
        case DATA_12_1: return "DATA_12_1";
        case RET_12_2: return "RET_12_2";
        case FUNC_13_0: return "FUNC_13_0";
        case LOOP_13_1: return "LOOP_13_1";
        case HEX_14_0: return "HEX_14_0";
        case RANGE_14_1: return "RANGE_14_1";
        case TEXT_14_2: return "TEXT_14_2";
        case TEXT_14_3: return "TEXT_14_3";
        case CASES_14_4: return "CASES_14_4";
        case FUNC_15_0: return "FUNC_15_0";
        case TEXT_15_1: return "TEXT_15_1";
        case TEXT_15_2: return "TEXT_15_2";
        case RET_15_3: return "RET_15_3";
        case DATA_16_0: return "DATA_16_0";
        case TEXT_16_1: return "TEXT_16_1";
        case TEXT_16_2: return "TEXT_16_2";
        case FUNC_17_0: return "FUNC_17_0";
        case DATA_17_1: return "DATA_17_1";
        case RET_18_0: return "RET_18_0";
        case RANGE_19_0: return "RANGE_19_0";
        case TEXT_19_1: return "TEXT_19_1";
        case TEXT_19_2: return "TEXT_19_2";
        case LOOP_21_0: return "LOOP_21_0";
        case BOOL_21_0: return "BOOL_21_0";
