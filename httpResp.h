...
private:
    ...
    bool range_1_1(state_t & state);
    bool text_1_2(state_t & state);
    bool range_1_3(state_t & state);
    bool range_1_4(state_t & state);
    bool range_1_5(state_t & state);
    ...
    bool range_4_1(state_t & state);
    bool text_4_2(state_t & state);
    bool text_4_3(state_t & state);
    ...
    bool text_6_0_0_0(state_t & state);
    ...
    bool text_18_1(state_t & state);
    bool text_18_2(state_t & state);
